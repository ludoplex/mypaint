...
from colour.colorimetry import (STANDARD_OBSERVERS_CMFS,
                                ...
                                sd_ones, spectral_to_XYZ_integration, sd_zeros)
...
print("Spectral to RGB Matrix is", np.matmul(XYZ_to_RGB_m, np.matmul(CMFS_, np.diag(illuminant_SPD_)) # weight for whitepoint
